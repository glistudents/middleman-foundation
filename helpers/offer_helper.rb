module OfferHelper
  ...
  def usa_offers
    [
      ...
      { position: :bottom, title: 'CheapOstay', details: 'Deals on Family Getaways! Save up to $30 with Promo Code FAMILY30<br/><br/> Book Now!', link_text: 'CheapOstay', link_url: 'http://www.kqzyfj.com/click-7316990-10767736-1425038751000', image: 'offers/usa/cheapostay.jpg' }
    ]
  end
